 ...
 */
@Autonomous(name = "Low Blue Test Auto")
public class LowBlueTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        double outtakePower = 0.45 * robot.getPowerMultiple();
        ...
        SequentialCommandGroup commands = new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        new SequentialCommandGroup(
                                ...
                                new ParallelCommandGroup(
                                        new OneTimeCommand(() -> leftTurretServo.setPosition(0.7)),
                                        new OneTimeCommand(() -> rightTurretServo.setPosition(0.7))
                                ),
                                new OneTimeCommand(() -> robot.theOuttake.transfer(outtakePower, currentAlliance)),
                                new YieldCommand(500),
                                new ParallelCommandGroup(
