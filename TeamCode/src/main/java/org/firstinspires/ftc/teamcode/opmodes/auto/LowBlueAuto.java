...
//            }
            ...
            if (runtime.milliseconds() < 2000) {
                ...
                rightFrontMotor.setPower(0);
                rightBackMotor.setPower(0);
                robot.theOuttake.outtake(0.4 * robot.getPowerMultiple());
//                rightOuttakeMotor.setPower(1.0);
//                leftOuttakeMotor.setPower(1.0);
            } else if (runtime.milliseconds() < 22000) {
                for (int i = 0; i < 4; i++) {
                    robot.theOuttake.transfer(0.5 * robot.getPowerMultiple(), currentAlliance);
                    transferTime.reset();
...
//                    }
            ...
            } else if (runtime.milliseconds() < 23000) {
